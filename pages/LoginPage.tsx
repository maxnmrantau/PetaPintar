...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  // Memicu modal saat tombol submit ditekan
  const handleFormSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setShowModal(true);
  };

  // Logika login yang dijalankan setelah konfirmasi di modal
  const processLogin = () => {
  ...
  return (
    <>
      <ConfirmationModal 
        ...
        onConfirm={processLogin}
        title="Akses Administrator"
        message="Anda akan memasuki halaman pengelolaan data sensitif. Pastikan Anda memiliki wewenang untuk melanjutkan."
        type="login"
